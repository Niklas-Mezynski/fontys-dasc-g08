...
revenue_gnp_regression <- lm(revenue ~ gnp, data = revnue_state_info2)
summary(revenue_pop_regression)

ggplot(data = revnue_state_info2, aes(x=gnp, y=revenue)) + geom_point() + geom_smooth(method =lm, level=0.95)
par(mfrow=c(2,2))
