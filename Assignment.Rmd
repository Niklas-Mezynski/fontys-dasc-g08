...
products <- read.csv("C:\\Users\\nikla\\Documents\\Uni\\Semester_3\\DASC\\Datasets\\BrazilianEcommerce\\olist_products_dataset.csv")
reviews <- read.csv("C:\\Users\\nikla\\Documents\\Uni\\Semester_3\\DASC\\Datasets\\BrazilianEcommerce\\olist_order_reviews_dataset.csv")
#seller <- read.csv("C:\\Users\\nikla\\Documents\\Uni\\Semester_3\\DASC\\Datasets\\BrazilianEcommerce\\olist_sellers_dataset.csv")
...
```{r}
orders_sellers <- orders_customer_items %>%
...
From this data you can see, that the biggest generated revenue per seller, ranges from 72833.60R\$ to 181113.92R\$.

Best reviewed Sellers. Count of reviews having at least 4 Stars
```{r}
seller_group <- orders_sellers %>%
  group_by(seller_id) %>%
